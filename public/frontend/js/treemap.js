...
closer.treemap = function () {
    ...
    */
    var initialize = function ($container, data) {
        ...
        // initialize chart
        closer.chart.initialize($('#chart'));

        closer.currentNode.data = data;
        ...
        */
        update = function (data) {
            ...
            // display treemap
            currentLevel = display(closer.currentNode.data);
        }
    ...
    */
    ieLabels = function (d) {
        ...
        */
        ...
        var description;
        if (closer.userContribution != null && closer.section == 'default') {
    ...
    */
    textLabels = function (d) {
        ...
        */
        ...
        // Note.
        // If we are in the default section and the user did enter his/her
    ...
    */
    updateTitle = function (data) {
        ...
        // main section such as revenues, default and funds need to have
        // descriptions
        if ($.inArray(data.key.toLowerCase(), closer.sections) > -1) {
            $('<div class="description">  </div>').appendTo($title).html(data.descr);
        }

        // make zoom-out button appear disabled while at root nodes
        if (closer.currentNode.data === closer.root) {
    ...
    */
    open = function (nodeId, transition) {
        ...
        zoneClick.call(null, findHash(nodeId, closer.root) || closer.root, false, transition || 1);
    },
    ...
    */
    zoneClick = function (d, click, transition) {
        ...
        if (click && d.hash === closer.currentNode.data.hash) {
        ...
        if (click) {
            pushUrl(closer.budget, closer.section, closer.thisYear, closer.mode, d.hash);
        }
        ...
        if(d.values[yearIndex].val === 0) {
            zoneClick.call(null, d.parent || closer.root.hash);
            return;
        }
        ...
        closer.currentNode.data = d;
        closer.currentNode.year = yearIndex;

        // update chart and cards
        closer.chart.open(d, d.color);
        closer.cards.open(d);
