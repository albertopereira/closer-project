...
<div id="navigation-container" class="span6" >
  <div class="title-head" style="height:70px;">
    <button id="zoombutton" class="btn pull-right">
      <i class="icon-zoom-out"></i> Voltar
    </button>
  </div>
  <div id="navigation" >
    <div id="ie-popover">
...
<!-- heatmap template -->
<script type="text/html" id="heatmap-template">
  <div class="row-fluid" id="heatmap_container" style="width:auto;">
  </div>
</script>
...
<script type="text/html" id="row-template">
  <div class="tablerow">
    <div class="bullet"> <img class="expand-icon" src="/frontend/img/listBullet.png" /> </div>
  </div>
</script>
